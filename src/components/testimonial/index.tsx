...
import img4 from "../../assets/testimonials/lara-testemonial.jpeg";
...
const textTestimonials = [
  {
    ...
    level: "Aspirante",
    imageUrl: img1,
    text: "Meu processo está sendo lindo e fecundo, a cada encontro ou oração em comunidade eu renovo minha fé e acredito fielmente que o meu Deus está por mim, seja nos meus momentos de luz ou de trevas.",
  },
  {
    name: "Alessandro",
    level: "Consagrado",
  ...
  },
  {
    ...
    level: "Aspirante",
    imageUrl: img4,
    text: "No Ágape 2025, me apaixonei pelos Sementes da Misericórdia e sua união. No ingresso, senti que voltei para casa e experimentei a pertença em Belém. O acolhimento sincero, sem julgamentos, me deu a certeza de buscar a vida consagrada. Deus me moldou e transformou. Sigo convicta no aspirantado.",
  },
];
      ...
      <div className="mx-auto max-w-4xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">
            Experiências de quem já percorreu esse caminho
          </h2>
        </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <footer>
                  ...
                  <p className="text-sm font-medium uppercase tracking-wide text-brand-sienna">
                    {item.level}
                  </p>
                </footer>
              </div>
              <p className="mt-4 text-sm leading-7 text-brand-sienna/70 sm:text-base">
                "{item.text}"
              </p>
            </blockquote>
          ))}

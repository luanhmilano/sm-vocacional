        ...
        <section id="what-is" className="px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mx-auto max-w-6xl rounded-3xl bg-brand-pearl/50 px-6 py-8 shadow-sm ring-1 ring-brand-cream sm:px-8 sm:py-10">
                <div className="max-w-3xl">
                    <p className="text-sm font-semibold uppercase tracking-[0.25em] text-brand-sienna">O que é</p>
                ...
                <div className="mt-10 grid gap-6 lg:grid-cols-2">
                    <article className="rounded-2xl border border-brand-cream p-5">
                        ...
                        <p className="mt-3 text-sm leading-7 text-brand-sienna/70 sm:text-base">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dignissimos consectetur nisi quisquam, obcaecati harum ad reiciendis nobis beatae iusto neque quaerat aliquam, est architecto facilis maxime? Aliquid iusto eos hic.</p>
                    </article>
                    ...
                    <article className="rounded-2xl border border-brand-cream p-5">
                        <h3 className="text-xl font-semibold">Fidelidade</h3>
                        <p className="mt-3 text-sm leading-7 text-brand-sienna/70 sm:text-base">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dignissimos consectetur nisi quisquam, obcaecati harum ad reiciendis nobis beatae iusto neque quaerat aliquam, est architecto facilis maxime? Aliquid iusto eos hic.</p>
                    </article>
                    ...
                    <article className="rounded-2xl border border-brand-cream p-5">
                        <h3 className="text-xl font-semibold">Processos Pessoais e Espirituais</h3>
                        <p className="mt-3 text-sm leading-7 text-brand-sienna/70 sm:text-base">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dignissimos consectetur nisi quisquam, obcaecati harum ad reiciendis nobis beatae iusto neque quaerat aliquam, est architecto facilis maxime? Aliquid iusto eos hic.</p>
                    </article>
                </div>
            </div>
